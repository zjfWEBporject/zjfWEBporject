$(function(){
		...
		console.log(mdy);
		 ...
		 if(flage){
			 ...
			 if(event.deltaY>0){
				...
				if(mdy<=(-bxht*9)&&mdy>(-bxht*10)){$('.box').animate({top:-bxht*9+'px'},700,function(){flage=true;});}
			 }else{
			 	//向上滚动
	...
	function modelxStart(){
		$('.box').animate({top:0+'px'},700,function(){flage=true;$('.hedtex').animate({top:'130px',opacity:'1'},700);$('.hedull').animate({bottom:'50px',opacity:'1'},700);});
	...
	function practicabilityStart(){
		var bxht = parseInt($('.box').css('height'));
		$('.box').animate({top:-bxht*2+'px'},700,function(){flage=true;$('.kongjian').animate({top:'0',opacity:'1'},700);$('.nngli').animate({top:'0',opacity:'1'},1000);$('.yingyim').animate({top:'0',opacity:'1'},1300);$('.spaciousspace').animate({bottom:'60px',opacity:'1'},1000);});
   ...
   function mileageStart(){
	   var bxht = parseInt($('.box').css('height'));
	   $('.box').animate({top:-bxht*3+'px'},700,function(){flage=true;$('.mileage-con').animate({bottom:'70px',opacity:'1'},700);$('.enrance>div').animate({bottom:'60px',opacity:'1'},700);$('.enrance>p').animate({top:'50px',opacity:'1'},700);$('.enrance>span:nth-of-type(1)').animate({top:'70px',opacity:'1'},700);$('.enrance>span:nth-of-type(2)').animate({top:'130px',opacity:'1'},700);});
	   $('.up').css({display:'block'}).attr({src:'../picture/uphei.png'});
	   $('.logo').css({position:'fixed',top:'0'}).find('img').attr('src','../picture/tslsvg.svg');
	   $('.leftcolumn>div').eq(3).css({outline:'2px solid white',background:'white'}).siblings('div').css({outline:'0px solid white',background:'white'});
	   $('.leftcolumn>span').eq(3).css({opacity:'1',color:'white'}).siblings('span').css({opacity:'0',color:'white'});
   }
   //第四块结束
   function mileageEnd(){
	  $('.mileage-con').animate({bottom:'0px',opacity:'0'},700); 
	  $('.enrance>div').animate({bottom:'0px',opacity:'0'},700);
	  $('.enrance>p').animate({top:'150px',opacity:'0'},700);
	  $('.enrance>span:nth-of-type(1)').animate({top:'170px',opacity:'0'},700);
	  $('.enrance>span:nth-of-type(2)').animate({top:'230px',opacity:'0'},700);
   }
   //第五块开始
   ...
   function automaticdriEnd(){
	...
	function performanceStart(){
		var bxht = parseInt($('.box').css('height'));
		$('.box').animate({top:-bxht*5+'px'},700,function(){flage=true;$('.pjieshao>div').animate({bottom:'00px',opacity:'1'},700);$('.pertex').animate({bottom:'80px',opacity:'1'},700);});
		 $('.up').css({display:'block'}).attr({src:'../picture/uphei.png'});
		  $('.logo').css({position:'fixed',top:'0'}).find('img').attr('src','../picture/tslsvg.svg');
   ...
   function performanceEnd(){
	    $('.pjieshao>div').animate({bottom:'-50px',opacity:'0'},700);
		$('.pertex').animate({bottom:'0px',opacity:'0'},700);
   }
   //第七快开始
   ...
   function appearanceStart(){
	   var bxht = parseInt($('.box').css('height'));
	   $('.box').animate({top:-bxht*7+'px'},700,function(){flage=true;$('.appeexpla').animate({top:'50px',opacity:'1'},700);$('.apecetex>div').animate({bottom:'00px',opacity:'1'},700);});
	   $('.logo').css({position:'fixed',top:'0'}).find('img').attr('src','../picture/tslsvg.svg');
	   $('.up').css({display:'block'}).attr({src:'../picture/uphei.png'});
	   $('.leftcolumn>div').eq(7).css({outline:'2px solid black',background:'black'}).siblings('div').css({outline:'0px solid black',background:'black'});
	   $('.leftcolumn>span').eq(7).css({opacity:'1',color:'black'}).siblings('span').css({opacity:'0',color:'black'});
   }
   //第八快结束
   function appearanceEnd(){
	   $('.appeexpla').animate({top:'150px',opacity:'0'},700);
	   $('.apecetex>div').animate({bottom:'-150px',opacity:'0'},700);
   }
   //第九快开始
   function specificationStart(){
	  var bxht = parseInt($('.box').css('height'));
	  $('.box').animate({top:-bxht*8+'px'},700,function(){flage=true;$('.speciimg>img').animate({opacity:'1'},900);$('.spectex').animate({right:'0',opacity:'1'},700);}); 
	  $('.up').css({display:'block'}).attr({src:'../picture/upbai.png'});
	  $('.logo').css({position:'fixed',top:'0'}).find('img').attr('src','../picture/tslsvgbai.svg');
   ...
   function orderStart(){
	   var bxht = parseInt($('.box').css('height'));
	   $('.box').animate({top:-bxht*9+'px'},700,function(){flage=true;$('.order>img').animate({right:'0',opacity:'1'},700)});
	   $('.logo').css({position:'fixed',top:'0'}).find('img').attr('src','../picture/tslsvg.svg');
	   $('.up').css({display:'block'}).attr({src:'../picture/uphei.png'});
	   $('.leftcolumn>div').eq(9).css({outline:'2px solid black',background:'black'}).siblings('div').css({outline:'0px solid black',background:'black'});
	   $('.leftcolumn>span').eq(9).css({opacity:'1',color:'black'}).siblings('span').css({opacity:'0',color:'black'});
   }
   //第十快结束
   function orderEnd(){
	   $('.order>img').animate({right:'-150px',opacity:'0'},700);
   }
